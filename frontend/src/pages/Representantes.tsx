...
import { ChevronDown, Users, TrendingUp, Target, DollarSign, Calendar } from 'lucide-react';
import {
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="overflow-x-auto">
                                <div style={{ minWidth: Math.max(500, combinedMesData.length * 52) }}>
                                    <ResponsiveContainer width="100%" height={220}>
                                        <BarChart data={combinedMesData} margin={{ left: 0, right: 8 }} barCategoryGap="30%">
                                            <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" vertical={false} />
                        ...
                        <div className="card-premium">
                            ...
                            <ResponsiveContainer width="100%" height={220}>
                                <LineChart data={mediaAnualData} margin={{ left: 0, right: 16 }}>
                                    <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" vertical={false} />
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        {clientes.map((c, i) => (
                                            <tr key={i} className="hover:bg-white/5 transition-colors">
                                                <td className="py-2.5 pr-4 text-slate-300 font-medium text-xs truncate max-w-[160px]">{c.nome}</td>
